...
//new query to remove duplicates.. but new query to get a TRIPID for this unique entry.
	...
	NGO_Projects.NGOcommID = NGO_Communities.NGOcommID AND Year = 2017 AND TripType.TypeName <> 'Fake' AND VolunteerTrip.OpenForApplications = 1 AND VolunteerTrip.School = Chapters.School ORDER BY EarliestDate ASC";
