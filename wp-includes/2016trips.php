...
<?php
$tripsQuery = mysql_query("SELECT * FROM `VolunteerTrip` WHERE YEAR = '2016'") or die(mysql_error());

if (mysql_num_rows($tripsQuery) <=  0) {
?>
	<p>
	We are currently working on organizing trips for 2016. For any trip related question, feel free to email us at <a href="mailto:trips@studentsofferingsupport.ca"> trips@studentsofferingsupport.ca. </a>
	</p>
...
echo '</td>';
	...
	echo'<a class="gdlr-button small" href="http://www.sosvolunteertrips.org/Trip-Info/?TripID='.$row2['TripID'].'"  target="_self" style="color:#ffffff; background-color:#94d64f; border-color:#368799; margin-bottom:0px;"> Info / Applysss! </a>';
echo '</td>';
echo '</tr>';
